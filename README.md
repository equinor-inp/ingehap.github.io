...
| dolomite             | 2.87           |  76.4   |  49.7   |                    |                         |
| limestone            | 2.71           |  74.8   |  30.6   |                    |                         |
...
- [Interpretation](https://library.seg.org/loi/inteio)
- [Journal of Environmental and Engineering Geophysics](https://library.seg.org/loi/jeegxx)
- [Leading Edge](https://library.seg.org/loi/leedff)
- [liveBooks Manning](https://livebook.manning.com/#!//library)
- [Lyell Collection](http://sp.lyellcollection.org/)
...
- [NPD - WKT = Well-known text](https://en.wikipedia.org/wiki/Well-known_text)
...
- [SEG e-books](https://library.seg.org/ebooks)
- [SEG Wiki](http://wiki.seg.org/wiki/Main_Page)
- [SPE, Store Account](https://store.spe.org/Members/MyAccount.aspx)
